        ...
        while(1):
            try:
                ...
                if image_result.IsIncomplete():
                    ...
                    #  optional parameter.
                    im_cv2_format = image_result.GetData().reshape(height,width,1)
                    #resized_image = cv2.resize(im_cv2_format,(width//2,height//2))
                    frame = imutils.resize(im_cv2_format, width=500)
